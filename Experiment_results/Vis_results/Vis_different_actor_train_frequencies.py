...
proposed_scheme = pd.read_csv('./2023-09-28 19-36-59/Train_Rewards.csv')
...
# B_1 scheme: Based proposed scheme, actor network训练频率为4个step训练一次
B_2_scheme = pd.read_csv('./2023-09-30 13-37-38/Train_Rewards.csv')
B_2_scheme_rewards = B_2_scheme[['Value']]
B_2_scheme_rewards_list = B_2_scheme_rewards.values.tolist()
B_2_scheme_smooth_rewards = _tensorboard_smoothing(np.round(B_2_scheme_rewards_list, 2), 0.95)
...
ax.plot(x, B_2_scheme_smooth_rewards, label="actor network train frequency: 1 / 2 step", color="#000000", zorder=5)
