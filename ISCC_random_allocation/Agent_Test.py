...
from Env.ISCC_test_Env import env
...
class Test():
    def __init__(self):
        ...
        # 设置实验名称
        self.exp_name = self.agent_class + "/" + self.env_name + "/2023-09-13-11-31-40"
    ...
    def test(self):
        ...
        for episode in range(self.episode_num):
            ...
            average_time_delay = step * 10
            print("episode:", episode, "number_tasks:", self.number_task, "task_completion_rate:", task_completion_rate,
                  "average_task_latency:", average_time_delay)
