...
class Train():
    def __init__(self):
        ...
        # 设置状态空间维度
        self.state_shape = [8, 8, 8, 8]  # [upload state, computing state, download state, time state]
        # 设置动作空间维度
        self.action_shape = [8, 8, 8]  # [uplink bandwidth ratio, computing resource ratio, downlink bandwidth ratio]
